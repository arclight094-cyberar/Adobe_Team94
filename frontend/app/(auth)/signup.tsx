...
export default function SignupScreen() {
  ...
  useEffect(() => {
    ...
    if (response.type === 'success') {
      ...
      showAlert('error', 'Google Auth Error', errorMessage);
  ...
  const handleGoogleAuth = async () => {
    ...
    if (!request) {
      ...
      showAlert('error', 'Error', 'Google auth is not ready. Please wait a moment and try again.');
      return;
    }
      ...
      <View style={[styles.container, { backgroundColor: colors.auth.background }]}>
        <View style={styles.imageSection}>
          ...
          <View style={styles.logoOverlay}>
            <Svg width={150} height={150} viewBox="0 0 1500 1500">
              <Path
        ...
        <View style={styles.contentSection}>
          ...
          <View style={styles.topContentWrapper}>
            <View style={styles.headerContainer}>
              <Text style={[styles.title, {fontFamily: "grift", color: colors.auth.text}]}>
                WELCOME TO ARCLIGHT.
              </Text>
            </View>
